...
class LinkedList
{
    ...
    public:
        ...
        //funcion
        void addFront(int dt, string name, string pr);
...
int main()
{
    ...
    cout << "Num de Id: ";
    cin >> num_id; cin.ignore();

    cout << "Nombre de usuario: ";
    getline(cin, username);
    
    cout << endl << "Tipos de perfiles: " << endl << endl;
    cout << "Administrador" << endl;
    cout << "Cliente" << endl;
    cout << "Trabajador" << endl << endl;

    cout << "Escriba a cual perfil pertenece: ";
    getline(cin, profile); 

    ll.addFront(num_id, username, profile);
    cout << endl;
    // Para imprimir
...
void LinkedList::addFront(int dt, string name, string pr){
...
void LinkedList::printForward(){
    ...
    while (nd!=trailer)
    {
        ...
        cout << "-------------------" << endl;
        cout << "Id: " <<  nd->id<< endl;
        cout << "Nombre: " <<nd->username<< endl;
        cout << "Perfil: "<<nd->profile << endl;
